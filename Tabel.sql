...
CustomerID INT CONSTRAINT Session_CustomerID_Fk FOREIGN KEY REFERENCES Customer(CustomerID) ON DELETE SET NULL ON UPDATE CASCADE,
PortID INT CONSTRAINT Session_PortID_Fk FOREIGN KEY REFERENCES [Port](PortID) ON DELETE SET NULL ON UPDATE CASCADE,
StartTime DATETIME CONSTRAINT Session_StartTime_DefNull DEFAULT NULL,
EndTime DATETIME CONSTRAINT Session_EndTime_DefNull DEFAULT NULL,
AmountToPay MONEY CONSTRAINT Session_AmountToPay_NotNull NOT NULL,
PaymentMode VARCHAR(30) CONSTRAINT Session_PaymentMode_NotNull NOT NULL,
